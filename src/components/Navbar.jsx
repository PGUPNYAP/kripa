...
const NAV_LINKS = ["Home", "About", "Events", "Blogs"];
    ...
    <nav className="w-full h-[81px] flex items-center justify-between bg-white px-[77px] border-b border-gray-100">
      ...
      <div className="flex items-center gap-4 shrink-0">
        <button
          ...
          className="border border-gray-400 text-gray-700 text-sm px-5 py-1.5 rounded-full bg-transparent hover:bg-gray-50 transition-colors cursor-pointer"
        >
          Contact Us
        </button>
