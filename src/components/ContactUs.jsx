                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
                        ...
                        <div className="w-full h-[395px] max-w-[510px] min-h-[380px] bg-white border border-[#d9d9d9] rounded-[30px] shadow-[0px_4px_4px_rgba(0,0,0,0.25)] p-8 md:p-10 flex flex-col justify-between">
                            ...
                            <div className="grid grid-cols-4 gap-2 mt-auto pt-4 border-t border-gray-100">
                                ...
                                {/* Instagram */}
                                <a
                                    href="https://www.instagram.com/kripa_library/"
                                    target="_blank"
                                    rel="noopener noreferrer"
                                    className="group flex flex-col items-center gap-2"
                                >
                                ...
                                {/* Facebook */}
                                <a
                                    href="https://www.facebook.com/p/Kripa-Library-Mandawali-61581788636814/"
                                    target="_blank"
                                    rel="noopener noreferrer"
                                    className="group flex flex-col items-center gap-2"
                                >
                        ...
                        {/* Map Placeholder */}
                        <div className="w-[742px] h-[387px] bg-[#d9d9d9] rounded-[30px] shadow-[0px_4px_4px_rgba(0,0,0,0.25)] overflow-hidden">
                            <iframe
                                title="Kripa Library Location"
                                src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3501.921344465431!2d77.29227242445104!3d28.629107584112933!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x390cf599573cea1d%3A0x621966c612f07566!2sKripa%20Library!5e0!3m2!1sen!2sin!4v1713740000000!5m2!1sen!2sin"
